...
To manage your servers and sites, we recommend using [Ploi.io](https://ploi.io/?ref=roadmap-github) to speed up things, obviously you're free to choose however you'd like to deploy this piece of software 💙
